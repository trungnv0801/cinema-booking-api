...
--comment cinema_id NULL means the role applies system-wide (ADMIN, CUSTOMER).
--comment For CASHIER it must be set: a Meridian Bay cashier may not sell tickets for Silver Creek.
